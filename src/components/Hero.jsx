  ...
  return (
    <div className='mt-32 flex items-center justify-between flex-col sm:flex-row'>
        ...
        >
            ...
            <p className='max-w-[500px] py-8 text-[#706f6c]'> Your friendly neighborhood frontend developer, I'm a Computer Science student at Babcock University with a passion for problem solving. With a strong foundation in Computer Science and Engineering principles and programming languages such as JavaScript/TypeScript, Python and C++, I am constantly seeking opportunities to learn and apply my skills in new and innovative ways. </p>
            <motion.a 
