...
const About = () => {
  return (
    ...
    >
        ...
        <p className='pb-16'> In addition to my academic pursuits, I have participated in numerous hackathons. I am also a team lead at the Google Developer Student Club at my school. I am a team player who enjoys collaborating with others and sharing knowledge.  Aside from writing software, I spend the majority of my days reading, watching anime, growing, and experimenting with new productivity hacks.
